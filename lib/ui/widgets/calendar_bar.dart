...
class _CalendarAppBarState extends State<CalendarBar> {
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      width: MediaQuery.of(context).size.width / 6 - 4.0,
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.roboto(
                              fontSize: 16.0,
                              color: isSelected ? accent : kcCalendarTitleColor,
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            TextButton.icon(
              onPressed: () {},
              icon: SvgPicture.asset('assets/images/icon-curved-calendar.svg'),
              label: Text(
                DateFormat.MMM(Locale(_locale).toString())
                    .format(selectedDate),
                style: GoogleFonts.roboto(
                  fontSize: 14.0,
                  fontWeight: FontWeight.normal,
