...
String getStringKeysCodeFromMap(Map<dynamic, dynamic> languageMap) {
  ...
  var classInfos = <StringsClassInfo>[];
...
class StringsClassInfo {
  ...
  StringsClassInfo({required this.className, required this.keys});
}
...
class PropertyInfo {
  ...
  PropertyInfo({required this.propertyName, required this.propertyValue});
}
